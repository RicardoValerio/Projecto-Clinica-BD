...
<head>
	<meta charset="UTF-8">
	<title>Galeria Pseudo Clínica</title>
<link rel="shortcut icon" href="../favicons/faviconFLAG.ico" type="image/x-icon">
...
#toolbar{position:fixed; z-index:3; right:10px; top:90px; padding:5px; background:url(fs_img_g_bg.png);}
#toolbar img{border:none;}
#fechar{position:fixed; z-index:3; right:10px; top:10px; padding:5px;}
...
<!--PRIMEIRA FOTO A SER CARREGADA - ESTA È REPETIDA UMA VEZ, É POR ISSO QUE O TOTAL APRESENTA UMA FOTO A MAIS-->
<div id="bg"><a href="#" class="nextImageBtn" title="next"></a><a href="#" class="prevImageBtn" title="previous"></a><img src="images/2.jpg" width="1680" height="1050" alt="" title="Flag" id="bgimg" /></div>
...
<div id="fechar"><a href="../index.php" title="Voltar" onClick=""><img src="voltar.png" width="50" height="50"  /></a></div>
...
<div class="thumbScroller">
	<div class="container">
    	<div class="content">
    <!-- AS PRIMEIRAS SAO AS GRANDES-->
        	<div><a href="images/2.jpg">
<!--AS DE BAIXO SAO AS PEQUENAS 220x138-->
        		<img src="images/2.1.jpg" title="Flag" alt="" width="220" height="138" class="thumb" /></a></div>
        </div>
        <div class="content">
        	<div><a href="images/1.jpg"><img src="images/1.2.jpg" title="Sala de Formação" alt="Lux Aeterna" width="220" height="138" class="thumb" /></a></div>
        </div>
    	<div class="content">
        	<div><a href="images/3.jpg"><img src="images/3.1.jpg" title="Giulia e Tadeu" alt="X-Wing on patrol" width="220" height="138" class="thumb" /></a></div>
        </div>
        <div class="content">
        	<div><a href="images/4.jpg"><img src="images/4.1.jpg" title="André" alt="Albireo Outpost" width="220" height="138" class="thumb" /></a></div>
        </div>
