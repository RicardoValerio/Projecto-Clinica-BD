...
<!-- Header and Nav -->
      ...
      <div class="twelve columns">
              ...
              <h5 style="color:red;font-size: 22px;">A sua marcação não foi realizada!</h5>
                <p style="text-align: center;">Não é possível marcar mais consultas de acordo com os valores submetidos.
                  <br>Por favor, tente de novo com outras condições.
                </p>
